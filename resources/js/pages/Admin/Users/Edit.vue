...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.user.name, href: UserController.edit.url(props.user.id) },
];
...
const form = useForm({
    ...
    region_id: props.user.region_id ?? ('' as string | number),
});
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-xl p-6">
            <Heading
                ...
                description="Update this user's profile and role assignment."
            />
